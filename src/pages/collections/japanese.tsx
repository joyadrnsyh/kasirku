...
export default function CollectionJapanesePage() {
  ...
  return (
    <DefaultLayout title="Koleksi | Japanese Minimalist">
      <section className="px-6 md:px-10 mt-10 mb-20">
        <div className="text-center mb-14">
          ...
          <p className="mt-4 text-lg text-neutral-600 max-w-2xl mx-auto">
            Keindahan dalam kesederhanaan. Koleksi yang terinspirasi dari
            estetika Jepang.
          </p>
        </div>
