...
export default function CollectionWinterPage() {
  ...
  return (
    <DefaultLayout title="Koleksi | Winter Collection">
      <section className="px-6 md:px-10 mt-10 mb-20">
        <div className="text-center mb-14">
          ...
          <p className="mt-4 text-lg text-neutral-600 max-w-2xl mx-auto">
            Hadapi musim dingin dengan gaya. Temukan pakaian hangat dan nyaman
            di sini.
          </p>
        </div>
