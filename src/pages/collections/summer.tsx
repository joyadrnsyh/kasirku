...
export default function CollectionSummerPage() {
  ...
  return (
    <DefaultLayout title="Koleksi | Summer Wear">
      <section className="px-6 md:px-10 mt-10 mb-20">
        <div className="text-center mb-14">
          ...
          <p className="mt-4 text-lg text-neutral-600 max-w-2xl mx-auto">
            Tampil segar dan nyaman di bawah sinar matahari dengan koleksi musim
            panas kami.
          </p>
        </div>
